...
When you click "Create a new function" in Supabase Dashboard, it shows a template. Here's exactly what to do:
...
2. **Delete the Template Code**
   - Select all the template code (Ctrl+A / Cmd+A)
   - Delete it (Delete key or Backspace)

3. **Paste the Real Code**
   - Copy the code below (the entire block)
...
```
1. [Create new function] → Name: "configure-sso-provider" → [Create]
...
- ✅ Function name must be exactly: `configure-sso-provider`
- ✅ Delete ALL the template code before pasting
- ✅ Make sure you paste the ENTIRE code block (all 201 lines)
- ✅ After deploying, you should see it in your functions list
...
2. You should see `configure-sso-provider` in the list
